package com.example.solution0801;

import java.util.HashMap;

import com.example.solution0801.BookProviderMetaData.BookTableMetaData;
...
public class BookProviderSolution extends ContentProvider
{
	// set logging tag
    ...
    static 
    {
    	...
    	/*
    	 * TODO: add description mapping for BOOK_DESCRIPTION
    	 */
    	
    	// Description field
    	sBooksProjectionMap.put(BookTableMetaData.BOOK_DESCRIPTION, 
    			                BookTableMetaData.BOOK_DESCRIPTION);
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) 
        {
        	...
        	/*
        	 * TODO: Add BOOK_DESCRIPTION to create command
        	 */
            ...
            db.execSQL("CREATE TABLE " + BookTableMetaData.TABLE_NAME + " ("
                    ...
                    + BookTableMetaData.BOOK_DESCRIPTION + " TEXT,"
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        /*
         * TODO: Add default value for BOOK_DESCRIPTION
         */

        if (values.containsKey(BookTableMetaData.BOOK_DESCRIPTION) == false) {
            values.put(BookTableMetaData.BOOK_DESCRIPTION, "no description given");
        }
