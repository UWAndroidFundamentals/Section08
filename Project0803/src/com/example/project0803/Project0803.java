...
public class Project0803 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listview.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				/*
				 * TODO: convert the passed id into an integer
				 * create a content resolver from the activity context
				 * create a URI from CONTENT_URI in the meta data
				 * append the id to the URI using URI.withAppendedPath
				 * invoke the delete method from the content resolver
				 */
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				/* 
				 * Add DESCRIPTION from passed values
				 */
